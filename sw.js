const CACHE = 'pistachio-v8-cardapio-1';
const ARQUIVOS = ['./','./index.html','./manifest.webmanifest','./icone-180.png','./icone-192.png','./icone-512.png','./robots.txt','./assets/arte-b.js?v=4','./assets/catalogo.js?v=4','./assets/estado.js?v=8.0','./assets/jogo.js?v=8.0','./assets/jogo.css?v=8.0','./assets/estilo-b-catalogo.png','./assets/estilo-b-cuidados.png','./assets/estilo-b-moveis.png','./assets/cenarios.png','./assets/armario.png','./assets/gestos.js?v=8.0','./assets/paginas.js?v=8.0','./assets/roupas-vestidas.png','./assets/banho.png','./assets/pizzaria-core.js?v=8.0','./assets/pizzaria.js?v=8.0','./assets/pizzaria.css?v=8.0','./assets/pizzaria-cozinha.png','./assets/pizzaria-clientes.png'];
