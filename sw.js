const CACHE = 'pistachio-v5-release-3';
const ARQUIVOS = ['./','./index.html','./manifest.webmanifest','./icone-180.png','./icone-192.png','./icone-512.png','./robots.txt','./assets/arte-b.js?v=4','./assets/catalogo.js?v=4','./assets/estado.js?v=4.1','./assets/jogo.js?v=5.3','./assets/jogo.css?v=5.3','./assets/estilo-b-catalogo.png','./assets/estilo-b-cuidados.png','./assets/estilo-b-moveis.png','./assets/cenarios.png','./assets/armario.png','./assets/gestos.js?v=5.3','./assets/paginas.js?v=5.3','./assets/roupas-vestidas.png','./assets/banho.png'];
