const CACHE = 'pistachio-pizzaqa-v6-2';
const ARQUIVOS = ['./','./index.html','./manifest.webmanifest','./icone-180.png','./icone-192.png','./icone-512.png','./robots.txt','./assets/arte-b.js?v=4','./assets/catalogo.js?v=4','./assets/estado.js?v=6.1','./assets/jogo.js?v=6.1','./assets/jogo.css?v=6.1','./assets/estilo-b-catalogo.png','./assets/estilo-b-cuidados.png','./assets/estilo-b-moveis.png','./assets/cenarios.png','./assets/armario.png','./assets/gestos.js?v=6.1','./assets/paginas.js?v=6.1','./assets/roupas-vestidas.png','./assets/banho.png','./assets/pizzaria-core.js?v=6.1','./assets/pizzaria.js?v=6.1','./assets/pizzaria.css?v=6.1','./assets/pizzaria-cozinha.png','./assets/pizzaria-clientes.png'];
...
self.addEventListener('activate',e=>e.waitUntil(caches.keys().then(ns=>Promise.all(ns.filter(n=>n.startsWith('pistachio-pizzaqa')&&n!==CACHE).map(n=>caches.delete(n)))).then(()=>self.clients.claim())));
