const CACHE = 'pistachio-pizzaqa-v6-1';
const ARQUIVOS = ['./','./index.html','./manifest.webmanifest','./icone-180.png','./icone-192.png','./icone-512.png','./robots.txt','./assets/arte-b.js?v=4','./assets/catalogo.js?v=4','./assets/estado.js?v=6','./assets/jogo.js?v=6','./assets/jogo.css?v=6','./assets/estilo-b-catalogo.png','./assets/estilo-b-cuidados.png','./assets/estilo-b-moveis.png','./assets/cenarios.png','./assets/armario.png','./assets/gestos.js?v=6','./assets/paginas.js?v=6','./assets/roupas-vestidas.png','./assets/banho.png','./assets/pizzaria-core.js?v=6','./assets/pizzaria.js?v=6','./assets/pizzaria.css?v=6','./assets/pizzaria-cozinha.png','./assets/pizzaria-clientes.png'];
